...
<body class="menu-always-on-top">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                    <a  class="scroll site-logo STYLE1">系部竞赛管理 </a></div>
                <!-- Logo END -->
            ...
            <div class="carousel-inner" role="listbox">
                        ...
                        <div class="center-block-wrap">
                            <div class="center-block-body">
                                <h2 class="margin-bottom-20 animate-delay carousel-title-v1" data-animation="animated fadeInDown">
                                    同济大学 <span class="color-red">浙江学院</span> 系部竞赛
                                </h2>
                                <div class="animated flipInX">
                                    <div class="hidden-xs">
                                        ...
                                        <div class="promo-like-text">
                                            ...
                                            <p>尽最大的努力<br> 做好每一件事 <a href="javascript:void(0);">加油！</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="item carousel-item-two">
                    <h2 class="carousel-position-one animate-delay carousel-title-v1" data-animation="animated fadeInDown">
                        同济大学 <span class="color-red">浙江学院</span> 校园风光
                    </h2>
                        ...
                        <div class="center-block-wrap">
                            <div class="center-block-body">
                                <h3 class="margin-bottom-20 animate-delay carousel-title-v2" data-animation="animated fadeInDown">
                                    我们总以为 <br/> 是生活欠我们一个“满意”
                                </h3>
                                <span class="carousel-subtitle-v1">其实是我们欠生活一个“努力”</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="about-block content content-center" id="about">
        <div class="container">
            <h2><strong>近期</strong>竞赛</h2>
            <h4>请认真阅读竞赛要求，积极参与</h4>
            <div class="ab-trio">
    ...
    <div class="services-block content content-center" id="services">
        <div class="container">
            <h2>竞赛 <strong>精神</strong></h2>
            <h4>相互理解、友谊长久、团结一致和公平竞争</h4>
            <div class="row">
    ...
    <div class="message-block content content-center valign-center" id="message-block">
        <div class="valign-center-elem">
            <h2>梦就在远方 脚踏实地向前闯 <strong>总有一天会展翅翱翔</strong></h2>
            <em>奇迹不过是努力的另一个名字，愿机会永远对你有利</em>
        </div>
    </div>
    <!-- Message block END -->
    ...
    <div class="choose-us-block content text-center margin-bottom-40" id="benefits">
        <div class="container">
            <h2>系部 <strong>英语竞赛</strong></h2>
            <h4>由各系组织学生参加 <a href="javascript:void(0);">学习英语可以提高自己的语言技能</a> 增加一项语言能力<br> 英语的学习伴随着我们的成长慢慢积累，你的英语水平是怎样的呢？通过本次竞赛展示给大家看看吧~</h4>
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 text-left">
                    <div class="panel-group" id="accordion1">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_1">报名时间</a>
                                </h5>
                            </div>
                            <div id="accordion1_1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <p>2020年5月25日--2020年6月5日</p> 
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_2">报名方式</a>
                                </h5>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_3">竞赛要求</a>
                                </h5>
                            </div>
                            <div id="accordion1_3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>系部安排竞赛选题，分为笔试部分和口语部分</p>
                                    <p>两部分个占总分数的50%</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_4">竞赛规则</a>
                                </h5>
                            </div>
                            <div id="accordion1_4" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>竞赛公平公正公开，不可作弊，一旦发现，取消参赛资格</p>
                                    <p>笔试中，请同学们自带铅笔和黑色碳素笔，口语竞赛会在开始前设置主题，有10分钟准备时间，可脱稿或不脱稿</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5 class="panel-title">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_5">竞赛时间</a>
                                </h5>
                            </div>
                            <div id="accordion1_5" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>笔试：2020年6月10日早上8：00，口语：2020年6月10日下午14：00</p>
                                  
                                </div>
                            </div>
                        </div>
                        <div class="footer text-center">
                            <a href="add.php"  name="submit" type="submit"  >报名</a>
                        </div>
                        </div>
                    </div>
                </div>
